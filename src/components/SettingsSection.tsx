  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <form onSubmit={handleSaveSettings} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Core Sourcing Rules */}
        <div className="lg:col-span-2 p-6 rounded-2xl border border-slate-900 bg-[#040815] space-y-6">
          <h2 className="text-xs font-mono font-bold text-slate-500 uppercase tracking-widest border-b border-slate-900/60 pb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-xs">
            ...
            <div className="space-y-2">
              <label className="text-slate-400 font-mono block">Primary Reporting Currency</label>
              <select
                value={currency}
                onChange={(e) => setCurrency(e.target.value)}
                className="w-full px-3 py-2 rounded-xl border border-slate-900 bg-slate-950 text-slate-300 focus:outline-none focus:border-indigo-500/50"
              >
            ...
            <div className="space-y-2">
              <label className="text-slate-400 font-mono block">Default Low-Stock Safety Threshold</label>
              <input
                type="number"
                value={alertThreshold}
                onChange={(e) => setAlertThreshold(e.target.value)}
                className="w-full px-3 py-2 rounded-xl border border-slate-900 bg-slate-950 text-slate-300 focus:outline-none focus:border-indigo-500/50 font-mono"
              />
              <span className="text-[10px] text-slate-500 block">Trigger warning alert when physical quantity falls below this limit.</span>
            </div>

            <div className="space-y-2">
              <label className="text-slate-400 font-mono block">Autonomous PO Approval Limit</label>
              <input
                type="number"
            ...
            <div className="space-y-3">
              <label className="flex items-start gap-3 cursor-pointer text-xs">
                <input
                  ...
                  className="mt-1 rounded border-slate-900 bg-slate-950 text-indigo-600 focus:ring-0"
                />
                <div className="space-y-0.5">
                  <span className="text-slate-200 font-semibold block">SLA Critical Stock Warning Emails</span>
              ...
              <label className="flex items-start gap-3 cursor-pointer text-xs">
                ...
                />
                <div className="space-y-0.5">
                  <span className="text-slate-200 font-semibold block">Autonomous Slack Channel Sourcing Logs</span>
        ...
        <div className="p-6 rounded-2xl border border-slate-900 bg-[#040815] flex flex-col justify-between space-y-6">
          <div className="space-y-5">
            ...
            <div className="space-y-3.5 text-xs">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                />
                <div className="space-y-0.5">
                  <span className="text-slate-200 font-semibold block">Mandate 2-Factor Authentication</span>
                  <p className="text-[10px] text-slate-500">Require mobile OTP signoff for all POs greater than $50,000.</p>
                </div>
              </label>

              <div className="p-3.5 rounded-xl bg-indigo-950/20 border border-indigo-500/10 text-slate-400 space-y-1.5 leading-relaxed">
